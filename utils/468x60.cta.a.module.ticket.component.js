{
            type: 'cta.a.module.ticket.component',
            ...
            headlinePosition: { x: 205, y: 30 },
            headlineText: 'Frame_2_Headline_standard_size',
            headlineAnimation: { fade: false, slideLeftToRight: false, slideRightToLeft: false, slideTopToBottom: false, zoom: false, fadeWithBounce: false, pulse: false, none: false },
            headlineAnimationTime: { time: 500, delay: 750 },

            imageMask: 'all_modules_ticket_mask.png',
            imageLayer: 'all_modules_ticket_image.png',
            imageTx: '<span style="line-height: 6px">&nbsp;</span><br>Viewing Details<br>Programme name',
            imageLogo: 'logo.png',
            ...
            ticketAnimationTime: { time: 750, delay: 750 },
